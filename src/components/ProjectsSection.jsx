...
const projects = [
  ...
  },
  {
    ...
    tags: ["Next.js", "Tailwind CSS", "Django", "Vue.js"],
    link: "#",
  },
  {
    id: 3,
    ...
    <section id="projects" className="py-24 px-4 relative min-h-screen">
      <div className="container mx-auto max-w-5xl">
              ...
              <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
                  A showcase of my work, highlighting the skills and technologies I've used.
              </p>
                      ...
                      <div className="p-6">
                        <div className="flex flex-wrap gap-2 justify-center">
                            {project.tags.map((tag) => (
                                <span key={tag} className="bg-primary/20 text-xs py-1 px-2 border font-medium rounded-full text-secondary-foreground">
                                    {tag}
                                </span>
                            ))}
                        </div>
              ...
              <div className="flex justify-center mt-12">
                  <a className="cosmic-button w-fit flex items-center mx-auto gap-2" href="https://github.com/eonsyntax" target="_blank">
